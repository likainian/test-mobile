...
import com.fly.video.databinding.FragVideoBinding
...
class VideoFrag : BaseBindFragment<FragVideoBinding>() {
    override fun createBinding(): FragVideoBinding {
        return FragVideoBinding.inflate(layoutInflater)
    }
